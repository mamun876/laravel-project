...
@section('content')
<form action="{{ route('sales_return.store') }}" method="post" style="width: 50%;" enctype="multipart/form-data">
    @csrf
    
    <label for="customerName">product_name:</label>
    <input type="text" name="product_name" placeholder="product_name" class="form-control" value="{{ old('product_name') }}">
    ...
    <input type="text" name="grand_total" placeholder="grand_total" class="form-control" value="{{ old('grand_total') }}">
    ...
    <input type="text" name="payment_status" placeholder="payment_status" class="form-control" value="{{ old('payment_status') }}">
